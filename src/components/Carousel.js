...
const Carousel = () => {
  const images = [
    { src: '/static/Skyscraper.png', alt: 'Image 1 description' },
    { src: '/static/Skyscraper2.png', alt: 'Image 2 description' },
  ];
  ...
  return (
    <div className="relative w-full md:w-5/6 lg:w-4/5 mx-auto mt-20">
